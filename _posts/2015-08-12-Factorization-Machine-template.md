...
<p>The above cost function <script type="math/tex" id="MathJax-Element-26213">(2)</script> works as following</p>
...
<blockquote>
  ...
  <blockquote>
    ...
    <blockquote>
      <p>For each rating <script type="math/tex" id="MathJax-Element-26214">r_{ui}</script> in the training set</p>
      
      <blockquote>
        <p><script type="math/tex" id="MathJax-Element-26215">e_{ui} \stackrel{def}{=} r_{ui} - q_i^Tp_u</script></p>
        
        <p><script type="math/tex" id="MathJax-Element-26216">q_i \gets q_i + \gamma(e_{ui} p_u -\lambda q_i)</script></p>
        
        <p><script type="math/tex" id="MathJax-Element-26217">p_u \gets p_u + \gamma (e_{ui}q_i -\lambda p_u)</script></p>
      </blockquote>
    </blockquote>
  </blockquote>
</blockquote>
